...
const Footer = () => (
  <footer className="p-6 bg-gray-800 text-gray-300 text-center font-serif dark:bg-gray-900 dark:text-gray-400">
    <p>&copy; 2024 ArtCollect | All Rights Reserved</p>
    <div className="flex justify-center space-x-4 mt-2">
      <a href="/support" className="hover:text-gray-500">Support</a>
